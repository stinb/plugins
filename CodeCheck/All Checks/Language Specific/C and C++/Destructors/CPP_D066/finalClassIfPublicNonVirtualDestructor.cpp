...
class A // UndCC_Violation - class A should not be used as a base class because
...
class B final // UndCC_Valid - class B can not be used as a base class, because
...
class C // UndCC_Valid - class C is not final, and its destructor is virtual. It
