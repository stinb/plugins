...
{
  const std::type_info& a = typeid(SideEffects()); /* UNDCC_Violation sideEffects() function not called */
  const std::type_info& b = typeid(A::F1()); /* UNDCC_Violation A::f1() functions called to determine */
