...
const A &Fn1(const A &ref) noexcept // UNDCC_Violation - the function returns a
...
const A &Fn2(A &ref) noexcept // UNDCC_Valid - non-const reference parameter does
...
const A *Fn3(const A &ref) noexcept // UNDCC_Violation - the function returns a
