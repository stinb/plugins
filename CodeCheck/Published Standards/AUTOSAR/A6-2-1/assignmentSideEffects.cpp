...
{
public:
  A& operator=(const A& oth) // UndCC_Valid
  {
    if(&oth == this)
    {
      return *this;
...
public:
  ...
  B& operator=(B&& oth)
  {
    ...
    // UndCC_Valid - this is not a side-effect, in this
...
public:
  C& operator=(const C& oth)
  {
    ...
    x = oth.x % 2; // UndCC_Violation - unrelated side-effect
    return *this;
}
...
public:
  ...
  D& operator=(const D& oth)
  {
    ...
    a = oth.a;
    // UndCC_Valid, not copying the debug information about number of modifications
    return *this;
  }
