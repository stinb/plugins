...
class A
{
    public:
        // Implementation
        A(A const& oth) : x(oth.x) // UNDCC_Valid
    {
    }
...
class B
{
    public:
        // Implementation
        B(B&& oth) : ptr(std::move(oth.ptr)) // UNDCC_Valid
    {
...
class C
{
    ...
    {
        // ...
        x = x % 2; // UNDCC_Violation - unrelated side-effect
    }
...
class D
{
    public:
        ...
        D(const D& d) : D(d.a) {} // UNDCC_Valid, not copying the debug information about number of modifications
