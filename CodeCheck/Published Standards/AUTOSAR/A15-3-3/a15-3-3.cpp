...
int MainGood(int, char **) // UndCC_Valid
{
    try
    {
        // program code
...
int MainBad(int, char **) // UndCC_Violation - neither unexpected exceptions
...
void ThreadMainGood() // UndCC_Valid
{
    try
    {
        // thread code
...
void ThreadMainBad() // UndCC_Violation - neither unexpected exceptions
// nor external libraries exceptions are caught
{
    try
    {
