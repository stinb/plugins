...
public:
    std::int32_t &operator[](
        std::int32_t index) // UndCC_Valid - non-const version
    {
        return container[index];
    }
    std::int32_t operator[](
        std::int32_t index) const // UndCC_Valid - const version
    {
        return container[index];
    }
...
class Container2 // UndCC_Violation - only non-const version of operator[]
// implemented
{
public:
