...
public class BankAccountCreator {
  public BankAccount createBankAccount(String accountNumber, String accountType,
    ...
    if(True){
      ...
      account.setAccountNumber(accountNumber); // UndCC_Valid
      account.setAccountType(accountType); // UndCC_Valid
      account.setAccountOwnerName(accountName); // UndCC_Valid
      account.setAccountOwnerSSN(accountSSN); // UndCC_Valid
      account.setBalance(balance); // UndCC_Valid
    }
    return account;
  }
}
