...
// Thread-safe class
public final class SocketReader4 implements Runnable {
  private final Socket primarySocket;
  private final BufferedReader in;
  private final Object lock = new Object();

  public SocketReader4(String host, int port) throws IOException {
  ...
  throws IOException, InterruptedException {
    SocketReader4 reader = new SocketReader("somehost", 25);
