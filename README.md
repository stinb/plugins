...
Checkout the [API tutorials](https://docs.scitools.com/help/apis/tutorials/tutorial-1-getting-started.html) for more help writing your own plugins.
The most up-to-date documentation is accessible from the Help menu in Understand. Select Help->Python API Documentation. You can also [access it here](https://docs.scitools.com/python/index.html).
